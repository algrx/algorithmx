...
it('Queue | Cancel', () => {
    ...
    return new Promise((resolve, reject) => {
        canvas
            .eventQ('q1')
            .pause(0.01)
            .callback(() => reject(new Error("queue didn't cancel")));
        canvas.cancel('q1');
        setTimeout(resolve, 20);
    });
});
...
it('Queue | Delayed start', () => {
    ...
    return new Promise((resolve, reject) => {
        ...
        canvas
            .eventQ(1)
            .pause(0.005)
            .callback(() => reject(new Error("queue shouldn't have started")));
...
it('Queue | Delayed stop', () => {
    ...
    return new Promise((resolve, reject) => {
        canvas
            .eventQ(1)
            .pause(0.015)
            .callback(() => reject(new Error("queue didn't stop")));
...
it('Queue | Cancel multiple', () => {
    ...
    return new Promise((resolve, reject) => {
        canvas
            .eventQ('q1')
            .pause(0.01)
            .callback(() => reject(new Error("queue 1 didn't cancel")));
        canvas
            .eventQ('q2')
            .pause(0.01)
            .callback(() => reject(new Error("queue 2 didn't cancel")));
